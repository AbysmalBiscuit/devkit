...
```
issue setup <ID|URL> [--slug <slug>] [--apps <a,b>] [--summary] [--dry-run] # id also accepted as --issue <ID>
...
issue_summary_path = "notes/{{ issue }}.md"     # relative to worktree_root
