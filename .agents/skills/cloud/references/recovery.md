Continue the active task from the conversation summary and its progress ledger. Keep the current objective, scope, chosen workflow, spec, and plan. Resume at the first unfinished action; completed tasks stay complete.
